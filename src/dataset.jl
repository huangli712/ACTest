...
const STD_FD = Dict{String,Any}[
    ...
    Dict(
        ...
        "mesh"  => "linear",
        "peaks" => [
            DeltaPeak(1.0,0.05,0.0),
            DeltaPeak(0.5,1.0,-3.0),
            DeltaPeak(0.5,1.0,3.0)
        ],
        "signs" => [1.0,1.0,1.0]
    ),
    ...
    Dict(
        ...
        "mesh"  => "linear",
        "peaks" => [
            DeltaPeak(1.0,0.05,-1.0),
            DeltaPeak(0.4,0.8,-3.0),
            DeltaPeak(0.4,0.8,3.0)
        ],
        "signs" => [1.0,1.0,1.0]
    ),
    ...
    Dict(
        ...
        "mesh"  => "linear",
        "peaks" => [
            DeltaPeak(1.0,0.2,0.0),
            DeltaPeak(0.6,0.6,-1.0),
            DeltaPeak(0.6,0.6,-3.0)
        ],
        "signs" => [1.0,1.0,1.0]
    ),
    #
    ...
    Dict(
        ...
        "peaks" => [
            DeltaPeak(1.0,0.2,0.0),
            DeltaPeak(0.1,0.4,-2.0),
            DeltaPeak(0.6,1.0,2.0)
        ],
        "signs" => [1.0,1.0,1.0]
    ),
    #
